    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bitcoin YOLO") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Bitcoin YOLO"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoin YOLO"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoin YOLO"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Bitcoin YOLO help message to get a list with possible Bitcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bitcoin YOLO client") + " " + networkStyle->getTitleAddText();
