...
BOOST_AUTO_TEST_CASE(DoS_banning)
{
    ...
    Network::misbehaving(dummyNode1.GetId(), 100); // Should get banned
    ...
    Network::misbehaving(dummyNode2.GetId(), 50);
...
BOOST_AUTO_TEST_CASE(DoS_banscore)
{
    ...
    CNode dummyNode1(INVALID_SOCKET, addr1, "", true);
    dummyNode1.nVersion = 1;
    Network::misbehaving(dummyNode1.GetId(), 100);
    SendMessages(&dummyNode1);
    BOOST_CHECK(!CNode::IsBanned(addr1));
    Network::misbehaving(dummyNode1.GetId(), 10);
    SendMessages(&dummyNode1);
    BOOST_CHECK(!CNode::IsBanned(addr1));
    Network::misbehaving(dummyNode1.GetId(), 1);
    SendMessages(&dummyNode1);
    BOOST_CHECK(CNode::IsBanned(addr1));
...
BOOST_AUTO_TEST_CASE(DoS_bantime)
{
    ...
    Network::misbehaving(dummyNode.GetId(), 100);
