...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinclassic.com", "www.bitcoinclassic.com", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinclassic.com]", "www.bitcoinclassic.com", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinclassic.com:80", "www.bitcoinclassic.com", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinclassic.com]:80", "www.bitcoinclassic.com", 80));
