...
The Bitcoin YOLO project has been designed to support multiple localisations. This makes adding new phrases, and completely new languages easily achievable. For managing all application translations, Bitcoin YOLO makes use of the Transifex online translation management tool.
...
See the [Transifex Bitcoin Clasic project](https://www.transifex.com/bitcoinclassic/bitcoinclassic/) to assist in translations. You should also join the translation mailing list for announcements - see details below.
...
You can find the Bitcoin translation project at [https://www.transifex.com/bitcoinclassic/bitcoinclassic](https://www.transifex.com/bitcoinclassic/bitcoinclassic).
...
The Bitcoin YOLO translation maintainer pdpi is found in the Slack - `https://bitcoinclassic.slack.com/`.
